...
class HealthSensorManager(context: Context) : SensorEventListener {
    ...
    // Samsung 手表有两个 type=21 传感器，getDefaultSensor 会返回 null，用 getSensorList 取第一个
    ...
    @Volatile private var lastAccMs   = 0L      // 加速度计软件降采样时间戳
    private val ACC_MIN_INTERVAL_MS   = 500L    // 最多 2Hz
